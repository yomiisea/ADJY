 ...
 float posiciones[][8]= 
{
  ...
  {-7,17, 1,14, -7,17,  0,14}, // pata 3 arriba y adelante 
  {-7,17, 1,12, -7,17,  0,14}, // pate 3 abajo y empuja
  {-7,17, 1,10, -7,17,  0,14}, // pate 3 abajo y empuja
  //delay
  {-7,12, 1,10, -7,12,  0,14}, // pate 3 abajo y empuja

  
  {-7,12, 5,5, -7,12,  0,14}, // pate 3 abajo y empuja
  {-7,12, 10,3, -7,12,  0,14}, // pate 3 abajo y empuja
  {-7,12, 10,0, -7,12,  0,14}, // pate 3 abajo y empuja
  

  
  {-7,18, 10,0, -7,18,  0,10}, // pate 3 abajo y empuja
  {-7,12, 10,0, -7,12,  0,10}, // pate 3 abajo y empuja
  {-7,18, 10,0, -7,18,  0,10}, // pate 3 abajo y empuja
  {-7,12, 10,0, -7,12,  0,10}, // pate 3 abajo y empuja
  {-7,18, 10,0, -7,18,  0,10}, // pate 3 abajo y empuja
  {-7,12, 10,0, -7,12,  0,10}, // pate 3 abajo y empuja
  ...
  {-7,12, 10,0, -7,12,  0,10}, // pate 3 abajo y empuja
  {-7,12, 10,3, -7,12,  0,10}, // pate 3 abajo y empuja
{-7,12, 5,5, -7,12,  0,14}, // pate 3 abajo y empuja
  {-7,12, 1,10, -7,12,  0,14}, // pate 3 abajo y empuja
...
{-7,17, 0,16, -7,17,  0,16}, // posicion 0
  ...
  {-5,12, 1,20, -5,12,  1,20}, // pate 3 abajo y empuja
 {-5,12, 3,15, -5,12,  1,20}, // pate 3 abajo y empuja
 {-5,12, 4,10, -5,12,  1,20}, // pate 3 abajo y empuja
 {-5,12, 3,15, -5,12,  1,20}, // pate 3 abajo y empuja
 {-5,12, 1,20, -5,12,  1,20}, // pate 3 abajo y empuja

 {-5,12, 0,17, -5,12,  0,17}, // pate 3 abajo y empuja
 {-5,12, 0,15, -5,12,  0,15}, // pate 3 abajo y empuja
 {-5,12, 0,12, -5,12,  0,12}, // pate 3 abajo y empuja
...
{
  {-7,17, 0,16, -7,17,  0,16}, // posicion 0
  {-3,13, 0,16, -3,13,  0,16}, // pata 3 arriba y adelante 
  {-1,10, 0,16, -1,10,  0,16}, // pate 3 abajo y empuja
  {-1,10, 1,15, -1,10,  1,15}, // pate 3 abajo y empuja
  //delay
  {-1,10, 3,12, -1,10,  1,20}, // pate 3 abajo y empuja
  {-1,10, 3,9, -1,10,  1,20}, // pate 3 abajo y empuja
  {-1,10, 3,9, -1,10,  1,20}, // pate 3 abajo y empuja
  {-1,10, 3,12, -1,10,  1,20}, // pate 3 abajo y empuja
  //delay
  {-1,10, 1,15, -1,10,  1,15}, // pate 3 abajo y empuja
