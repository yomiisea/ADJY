...
float posiciones1[][8]= 
{
  {-7,17, 0,16, -7,17,  -2,16}, // posicion 0
  {-7,17, 3, 9, -3,17,  -2,18}, // pata 2 arriba y adelante
  {-7,17, 3,16, -3,17,  -2,16}, // pata 2 abajo y emupa
  {-7,17, 0,16, -3,17,  -2,16}, // posicion 0
  { 0,11, 3,16, -3,18.5,  -2,16}, // pata 1 arriba y adelante 
  {-3,17, 3,16, -3,17,  -2,16}, // pate 1 abajo y empuja
  {-7,17, -3,16, -3,17,  -2,16}, // posicion 0
  {-7,17, 0,16, -7,17,  -2,16}, // posicion 0


  
  {-7,17,  -2,16, -7,17, -4,16}, // posicion 0

  {0,13,  0,16, -8,17, -7,14}, // posicion 0
  
  {0,13,  0,16, -8,17, -7,14}, // posicion 0

  {-3,17,  0,12, -3,17, -7,16}, // posicion 0

  {-3,17, -4,14, -3,17, -4,14}, // posicion 0

  {-3,17,  0,16, -7,17, -4,14}, // posicion 0
